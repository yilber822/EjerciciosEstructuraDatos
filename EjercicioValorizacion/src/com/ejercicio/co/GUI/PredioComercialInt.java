 ...
 * @author unknown
 */
public class PredioComercialInt extends JPanel implements ActionListener {
    public PredioComercialInt() {
        initComponents();
    ...
    private void callPredioRecidencial() {
		...
		long ingresosReportados =Long.parseLong(this.MetrajeTextField3.getText());
		Predio predio;
